...
* "**ETL_Mini_Project_OSLinden**" [Link] (#https://github.com/LegallyNotBlonde/Crowdfunding_ETL/blob/main/ETL_Mini_Project_OSLinden.ipynb) file contains the main ETL code using Pandas libraries, comprehensive data manipulation, and Regex.
